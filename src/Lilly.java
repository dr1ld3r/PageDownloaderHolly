...
public class Lilly {
    ...
    static String BASE_DIR = "C:/FILES/marzabal/test/Lilly/";
    ...
    private static String getPhotosPage(){
            return "http://members.lilly-exposed.com/members/?page_id=4";
    }
    ...
    private static ArrayList<String> getImagesLinks(String[] imagesPage){
        ...
        for(String[] page: setPages)
            for(String line: page)
                if(line.contains("<a href=\"http://members.lilly-exposed.com/members/wp-content/gallery"))
    ...
    private static ArrayList<String[]> getSetPages(String[] firtImagesPage){
        ...
        for(int i=0;i<pagesLinkArray.length;i++) {
            ...
            if(pagesLinkArray[i].contains("href"))
                pagesLinkArray[i] = "http://members.lilly-exposed.com" + pagesLinkArray[i].substring(pagesLinkArray[i].indexOf("href=\"")+6, pagesLinkArray[i].indexOf("\">")).replace("amp;","");
        }
    ...
    private static String getPostLink(String post[]){
        for(String line: post)
            if(line.contains("Link")) {
                return "http://members.lilly-exposed.com" + line.substring(line.indexOf("href=\"") + 6, line.indexOf("\">")).replace("amp;","");
            }
    ...
    private static class CustomAuthenticator extends Authenticator {
        ...
        protected PasswordAuthentication getPasswordAuthentication(){
            ...
            String username = "beadle1";
            String password = "safc4eva";
